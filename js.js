const link_all = document.querySelectorAll('.link_all'),
...
const pairant_nav = document.querySelector('.pairant_nav');
const logo = document.querySelector('.logo');
const ul = document.querySelector('.pairant_nav ul');
window.onscroll = () => {
...
const lis = document.querySelectorAll('.pairant_nav ul li');
...
const imgs = ['../../img100/gym19.png' , '../../img100/gym2.png' , '../../img100/gym23.png'];
const pair_single = document.querySelector('.pair_single');
const one = document.querySelector('.one');
const two = document.querySelector('.two');
const three = document.querySelector('.three');

const hl = document.getElementById('h1');
const span = document.getElementById('span');
const button = document.getElementById('button');
const p = document.getElementById('p');
const hl2 = document.getElementById('h12');
const span2 = document.getElementById('span2');
const button2 = document.getElementById('button2');
const p2 = document.getElementById('p2');
const hl3 = document.getElementById('h13');
